...
public class FMLControlledNamespacedRegistry<I> extends RegistryNamespaced {
    ...
    {
        return cast(super.func_148754_a(id));
    }
    ...
    {
        I ret = cast(super.func_82594_a(name));
    ...
    Map<String,Integer> getEntriesNotIn(FMLControlledNamespacedRegistry<I> registry)
    {
        ...
        for (I thing : this.typeSafeIterable())
        {
            ...
            {
                if (!registry.activeSubstitutions.containsKey(func_148750_c(thing)))
                {
    ...
    void dump()
    {
        ...
        {
            I thing = getRaw(id);
            FMLLog.finer("Registry: %d %s %s", id, func_148750_c(thing), thing);
        }
    }
