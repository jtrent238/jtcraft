...
public class GuiSelectString extends GuiScreen
{
    ...
    {
        this.entriesList = new GuiSelectStringEntries(this, this.field_146297_k, this.configElement, this.selectableValues);
    ...
    {
        this.func_146276_q_();
        this.entriesList.func_148128_a(par1, par2, par3);
        ...
        this.btnDefault.field_146124_l = enabled && !this.entriesList.isDefault();
        this.btnUndoChanges.field_146124_l = enabled && this.entriesList.isChanged();
