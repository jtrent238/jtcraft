...
public class GuiUtils 
{
    ...
    public static void drawTexturedModalRect(int x, int y, int u, int v, int width, int height, float zLevel)
    {
        ...
        tessellator.func_78374_a((x + 0), (y + height), zLevel, ((u + 0) * var7), ((v + height) * var8));
        tessellator.func_78374_a((x + width), (y + height), zLevel, ((u + width) * var7), ((v + height) * var8));
        tessellator.func_78374_a((x + width), (y + 0), zLevel, ((u + width) * var7), ((v + 0) * var8));
        tessellator.func_78374_a((x + 0), (y + 0), zLevel, ((u + 0) * var7), ((v + 0) * var8));
